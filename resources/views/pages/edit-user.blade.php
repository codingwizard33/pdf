                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Email" value="" required>
                                    @if ($errors->has('email'))
                                        <span class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="user_name" name="user_name" class="form-control{{ $errors->has('user_name') ? ' is-invalid' : '' }}" placeholder="Phone" value="" required>
